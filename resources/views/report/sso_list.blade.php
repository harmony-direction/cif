        ...
        <div>
            <div class="container-fluid">
                <div class="title-header">
                    <div>
                        <h3 class="m-0">ประกันสังคม - รายชื่อพนักงานแสดงการส่งการเงินสมทบ (สปส 1-10) {{ $typeData }}</h3>
                    </div>
        ...
        <script>
            $(document).ready(function(){
                    $('#search_work_schedule').click(function(){
                        ...
                        var month = $('#month').val();
                        var type = '{{ $type }}';
                        var url = "{{ route('ssoPayment', ['year' => ':year', 'month' => ':month', 'type' => ':type']) }}".replace(':year', year).replace(':month', month).replace(':type', type);
