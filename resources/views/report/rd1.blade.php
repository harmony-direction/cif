    ...
    <div id="pdfContent" class="container" style="padding: 10px;">
        <div class="wrap-header" style="display: block; width: 100%;">
            <div style="display: block; width: 70%; float: left;">
                ...
                <span style="font-size: 15px; border: 1px solid #000;">     0205538000999     </span>
            </div>
            ...
            <div style="/* display: block; */ width: 28%; float: right;">
                ...
                <span style="font-size: 16px;">{PAGENO} </span>

                <span style="font-size: 16px;">ในจำนวน</span>

                <span style="font-size: 16px;">{nb}</span>

                <span style="font-size: 16px;">แผ่น</span>
            </div>

            <div class="box-header">
                <span style="font-size: 16px;">(ให้แยกกรอกรายการในใบแนบนี้ตามเงินได้แต่ละประเภท โดยใส่เครื่องหมาย “/”
                    ลงใน</span>
                <input type="checkbox">
                ...
                <div style="display: block; width: 50%; float: left;">
                    ...
                    <span style="font-size: 16px;">กรณีได้รับอนุมัติจากกรมสรรพากรให้หักอัตรา</span>    <span
                        style="font-size: 16px; font-weight: bold;">ร้อยละ 3</span>
                </div>
                <div style="display: block; width: 50%; float: right;">
                    <input type="checkbox">

                    <span style="font-size: 16px;">(3) เงินได้ตามมาตรา 40 (1) (2)
                        กรณีนายจ้างจ่ายให้ครั้งเดียวเพราะเหตุออกจากงาน</span>
                    <br>
                    <input type="checkbox">

                    <span style="font-size: 16px;">(4) เงินได้ตามมาตรา 40 (2)
                        กรณีผู้รับเงินได้เป็นผู้อยู่ในประเทศไทย</span>
                    <br>
                    <input type="checkbox">

                    <span style="font-size: 16px;">(5) เงินได้ตามมาตรา 40 (2)
                        กรณีผู้รับเงินได้มิได้เป็นผู้อยู่ในประเทศไทย</span>
                </div>
            </div>
            <table class="table-report">
                <thead>
                    <tr style="border-bottom: 1px solid #000;">
                        <td rowspan="4"
                            style="border: 1px solid #000; text-align: center; vertical-align: middle; padding: 2px;">
                            ลำ<br>ดับ<br>ที่</td>
                    ...
                    <tr style="border-bottom: 1px solid #000;">
                        <td style="border-left: 1px solid #000; text-align: center;">เลขประจำตัวผู้เสียภาษีอากร <span
                                style="font-size: 12px; color: #474747;">(ของผู้มีเงินได้)</span></td>
                        <td rowspan="3" style="border-left: 1px solid #000; text-align: center; padding: 0px 7px;">
                            มีสามี<br>ภริยา<br>หรือไม่</td>
                        <td colspan="2" style="border-left: 1px solid #000; text-align: center;">จำนวนบุตร</td>
                        <td style="border-left: 1px solid #000; text-align: center; padding: 0px 2px;">ค่าลดหย่อนอื่นๆ
                        </td>
                    </tr>
                    <tr style="border-bottom: 1px solid #000;">
                        <td rowspan="2"
                            style="border-left: 1px solid #000; text-align: center; vertical-align: middle;">
                            ชื่อผู้มีเงินได้</span></td>
                        <td rowspan="2"
                            style="border-left: 1px solid #000; text-align: center; vertical-align: middle; padding: 0px 2px;">
                            ศึกษา</td>
                        <td rowspan="2"
                            style="border-left: 1px solid #000; text-align: center; vertical-align: middle; padding: 0px 2px;">
                            ไม่<br>ศึกษา</td>
                ...
                <tbody>
                    ...
                    @foreach ($users as $key => $user)
                        ...
                        <tr style="border-bottom: 1px solid #000;">
                            ...
                            <td style="border-left: 1px solid #000; text-align: center; vertical-align: middle;">0</td>
                            <td style="border-left: 1px solid #000; text-align: center; vertical-align: middle;">
                                {{ $userSummary['socialSecurityFivePercent'] }}</td>
                            <td style="border-left: 1px solid #000; text-align: center; vertical-align: middle;">
                                เงินเดือน</td>
                            <td style="border-left: 1px solid #000; text-align: center; vertical-align: middle;">(4)
                            </td>
                            <td style="border-left: 1px solid #000; text-align: center; vertical-align: middle;">
                                {{ $userSummary['salary'] }}</td>
                            <td style="border-left: 1px solid #000; text-align: center; vertical-align: middle;">
                                -</td>
                            <td style="border-left: 1px solid #000; text-align: center; vertical-align: middle;">(1)
                            </td>
                        </tr>
                        @php
                            $salary = floatval(str_replace(',', '', $userSummary['salary']));
                            $allSum += $salary;
                            //$allSum += isset($userSummary['salary']) && is_numeric($userSummary['salary']) ? $allSum+$userSummary['salary']:0;
                        @endphp
                    @endforeach
                    <tr style="border: 1px solid #000;">
                        <td colspan="9">
                            ...
                            <span
                                style="font-size: 12px; font-style: italic; color: #474747;">(ให้กรอกลำดับที่ต่อเนื่องกันทุกแผ่น)</span>
                        ...
                        <td style="text-align: center; border: 1px solid #000;">{{ number_format($allSum,2) }}</td>
            ...
            <div class="footer-box">
                <div style="width: 65%; float: left;">
                    ...
                    <span style="font-size: 12px; color: #474747;">1. ให้ระบุว่า "มี" หรือ "ไม่มี" สามีภริยา
                        โดยใส่เครื่องหมาย / ลงใน <input type="checkbox"> หน้าข้อความแล้วแต่กรณี
                        พร้อมทั้งกรอกจำนวนบุตรที่มีสิทธิหักลดหย่อนศึกษากี่คน</span>
                    <br>

                    <span style="font-size: 12px; color: #474747;">ไม่ศึกษากี่คน และยอดรวมจำนวนค่าลดหย่อนอื่นๆที่จ่าย
                        ได้แก่ เบี้ยประกันชีวิต เงินสะสมฯ ดอกเบี้ยเงินกู้ยืมเพื่อซื้อ เช่าซื้อ หรือ
                        สร้างอาคารอยู่อาศัย</span>
                    <br>

                    <span style="font-size: 12px; color: #474747;">และเงินสมทบ</span>
                    <br>
                    <span style="font-size: 12px; color: #474747;">2. ให้กรอกประเภทเงินที่จ่าย เช่น เงินเดือน ค่าจ้าง
                        เบี้ยเลี้ยง โบนัส บำเหน็จ เงินค่าเช่าบ้าน ค่าธรรมเนียม ค่านายหน้า เบี้ยประชุม ค่าภาษีเงินได้
                        ฯลฯ</span>
                    <br>
                    <span style="font-size: 12px; color: #474747;">3. จำนวนคราวที่จ่ายทั้งปี ให้กรอกดังนี้
                        -จ่ายเป็นรายวัน กรอก 1     -จ่ายเป็นรายสัปดาห์ กรอก 2     -จ่ายเป็นรายปักษ์ กรอก 3</span>
                    <br>

                    <span style="font-size: 12px; color: #474747;">-จ่ายเป็นรายเดือน กรอก 4
                        -จ่ายเป็นจำนวนคราวไม่แน่นอน กรอก 5</span>
                    <br>
                    <span style="font-size: 12px; color: #474747;">4. เงื่อนไขการหักภาษี ให้กรอกดังนี้     -หัก ณ
                        ที่จ่าย กรอก 1     -ออกให้ตลอดไป กรอก 2     -ออกให้ครั้งเดียว กรอก 3</span>
                </div>
                <div style="width: 35%; float: right;">
                    <div style="margin-top: 10px;">
                        ...
                        <div style="width: 80%; float: right;">
                            ...
                            @endphp
                            <span
                                style="border-bottom: 1px dotted #000;">{{ \Carbon\Carbon::now()->format('d') }}<span>   เดือน   </span>{{ $month }}<span>   พ.ศ.   </span>{{ \Carbon\Carbon::now()->format('Y')+543 }}</span>
                        </div>
                    </div>
                </div>
            </div>
