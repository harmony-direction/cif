        ...
        <div>
            <div class="container-fluid">
                <div class="title-header">
                    <div>
                        <h3 class="m-0">ข้อมูลพนักงาน แนบการยื่นภาษีสรรพกร (รายปี)</h3>
                    </div>
                    <div aria-label="breadcrumb">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">หน้าหลัก</a></li>
                            <li class="breadcrumb-item active">เลือกเดือน/ปี ส่งออกไฟล์</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <script>
            $(document).ready(function(){
                    $('#search_work_schedule').click(function(){
                        var year = $('#year').val();
                        var month = $('#month').val();
                        var url = "{{ route('pnd.year', ['year' => ':year', 'month' => ':month']) }}".replace(':year', year).replace(':month', month);
